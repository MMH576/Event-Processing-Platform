...
const organization_member_guard_1 = require("./guards/organization-member.guard");
...
exports.OrganizationsModule = OrganizationsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [organizations_service_1.OrganizationsService, organization_member_guard_1.OrganizationMemberGuard],
